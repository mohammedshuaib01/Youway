...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='product_images',null=True, blank=True,default='product_image/default.jpg')
...
class Basket(models.Model):
    ...
    def get_cart_item(self):
        ...
        # return BasketItem.objects.filter(basket_object=self,is_order_placed=False)
